        ...
        <div className="about-sticky">
          ...
          >
            <div className="info-inner">
              ...
              <p>
                Jatin Lakhani
BCA (Semester 4) | Cyber Security Student | Backend Developer

Backend-focused developer with strong command over Java and Python, experienced in building secure, scalable, and performance-driven backend systems. Skilled in OOP, data structures, APIs, database integration, and backend architecture environment.
              </p>

              <p>
                Cyber Security student with a deep understanding of secure coding practices, authentication, authorization, and system-level security. Comfortable working with server-side logic, debugging complex flows, and optimizing backend performance.
              </p>

              <p>
                Actively seeking backend or cybersecurity internship opportunities to build production-level systems and contribute to real-world applications.
                              </p>
            </div>
          </div>
        </div>
