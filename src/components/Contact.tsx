...
export function Contact() {
  ...
  const contactInfo = [
    { icon: Mail, label: "Email", value: "jatinlakhani0596@gmail.com" },
    { icon: Phone, label: "Phone", value: "+91 9328688819" },
    { icon: MapPin, label: "Location", value: "bhavnagar, Gujarat, India" },
  ];

  const quickLinks = [
    { icon: Github, url: "https://github.com/jatinlakhani0596-create" },
    { icon: Linkedin, url: "https://www.linkedin.com/in/jatin-lakhani-1a2324305/" },
    { icon: Mail, url: "mailto:jatinlakhani0596@gmail.com" },
    { icon: MessageCircle, url: "https://wa.me/+919328688819" },
    { icon: Instagram, url: "https://www.instagram.com/_jatin_596_?igsh=bHNqb2hxaHRhbmo1" },
  ];
