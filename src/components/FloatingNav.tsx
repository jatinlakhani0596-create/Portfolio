...
export function FloatingNav() {
  const socialLinks = [
    { icon: Github, href: 'https://github.com/jatinlakhani0596-create', label: 'GitHub' },
    { icon: Linkedin, href: 'https://www.linkedin.com/in/jatin-lakhani-1a2324305/', label: 'LinkedIn' },
    { icon: Instagram, href: 'https://www.instagram.com/_jatin_596_?igsh=bHNqb2hxaHRhbmo1', label: 'Instagram' },
    { 
      icon: () => (
      ...
      href: 'https://leetcode.com/u/Jatinlakhani0596/', 
      label: 'LeetCode' 
    },
    { icon: Mail, href: 'mailto:jatinlakhani0596@gmail.com', label: 'Email' },
  ];
